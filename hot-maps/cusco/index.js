...
loadBuildingStats(function(stats) {
  ...
  map.on('load', function() {
    ...
    var minDay = isNaN(parseInt(getQueryVariable('minday'))) ? 0 : parseInt(getQueryVariable('minday'));
    var day = isNaN(parseInt(getQueryVariable('day'))) ? 0 : parseInt(getQueryVariable('day'));
    var speed = parseInt(getQueryVariable('speed')) || 260;
    range.min = minDay;
