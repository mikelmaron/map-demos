...
function createLayers() {
    map.addSource('greenland-hex', {
        type: 'vector',
        tiles: ['https://mikelmaron.github.io/map-demos/arctic-basecamp/tiles/{z}/{x}/{y}.pbf']
    });
    ...
    times.forEach(time =>  {
        map.addLayer({
            ...
            'source-layer': 'interpolated_greenland_grace_data_clipped',
            'paint': {
                'fill-color': [
                    "interpolate",
                    ["linear"],
